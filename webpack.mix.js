...
mix
    ...
    // tranferindo os arquivos do diretorio resources para public px541088473br 
    ...
    // a styles, metodo de compactamento de varios arquivos em um só 
    .styles([
    ...
    .scripts([
        'resources/views/admin/assets/js/jquery.min.js'],'public/backend/assets/js/jquery.js')
    .scripts([
        'resources/views/admin/assets/js/login.js'],'public/backend/assets/js/login.js')
    ...
    .scripts([
        'resources/views/admin/assets/js/scripts.js'],'public/backend/assets/js/scripts.js')
